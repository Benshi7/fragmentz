...
export default function SkillsPage() {
  return (
    ...
    <div className="mx-4 mb-16 xl:mx-12 md:mx-12 ">
      <div className="grid grid-cols-1 xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 ">
        ...
        <SkillCard title="CSS" shortDescription={"Cascade Style Sheet, define the design of html file. "} link={"https://developer.mozilla.org/en-US/docs/Web/CSS"} image={"src/assets/cssLogo.svg"}/>
        ...
        <SkillCard title="Tailwind" shortDescription={"The CSS framework to create attractive designs."} link={"https://tailwindcss.com/"} image={"src/assets/tailwindLogo.svg"}/>
