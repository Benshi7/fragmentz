    ...
    <div className="flex justify-center items-center px-32 max-md:px-5 md:px-64">
      <div className="w-full px-12 max-w-[897px] md:max-w-full">
        <div className="flex flex-col md:flex-row md:gap-5">
          <div className="order-2 md:order-1 flex flex-col md:w-6/12">
            <form className="flex flex-col grow text-base font-semibold tracking-normal text-white md:mt-10">
              <div className="text-2xl mb-4 font-bold tracking-wide md:text-3xl">
              💜 Hello. Let's talk.
              </div>
              ...
              <button
                type="submit"
                className="justify-center self-end px-2 py-2.5 mt-6 text-base tracking-normal text-center text-primary whitespace-nowrap rounded-lg bg-gray"
                tabIndex="0"
              >
                SEND MESSAGE
              </button>
